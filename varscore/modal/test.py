...
def score_variants(model_loc: str, peak_distr_loc: str, variants_loc: str, genome_loc: str):
    print("Loading model...")
    model = load_chrombpnet(model_loc)
    print("Model loaded successfully")
    
    print("Loading peaks...")
    peaks = np.load(peak_distr_loc)
    print(f"Peaks distribution loaded successfully")
    
    print("Loading variants...")
    variants = load_variants(variants_loc)
    print(f"Variants loaded successfully: {len(variants)} variants")
    
    print("Opening genome file...")
    genome = pyfaidx.Fasta(genome_loc)
    print("Genome file opened successfully")
