...
def annotate_variants(variants: List[VariantAnnotationInput], 
    ...
    if maternal_variants and paternal_variants:
        return [annotate_variant(variant, maternal_variants, paternal_variants) for variant in variants]
    return [annotate_variant(variant) for variant in variants]

def annotate_variant(variant: VariantAnnotationInput, 
    maternal_variants: Optional[List[VariantAnnotationInput]] = None, 
    paternal_variants: Optional[List[VariantAnnotationInput]] = None        
) -> AnnotatedVariant:
    ...
    inheritance = None
    if maternal_variants and paternal_variants:
        inheritance = trio_annotation(variants_char=variant, maternal_variants=maternal_variants, paternal_variants=paternal_variants)
