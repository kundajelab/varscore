...
def plot_variants(
	...
	for index, row in variants_df.iterrows():
		...
		ref_length = len(ref)
		alt_length = len(alt)
		payloads.append((ref_profile, alt_profile, ref_shap, alt_shap, ref_length, alt_length, ref_label, alt_label, 300))
	# Plot
...
def _plot_variant_and_save(allele1_pred, allele2_pred, allele1_shap, allele2_shap, allele1_length, allele2_length, allele1_label, allele2_label, window_size, title, save_loc):
	fig = plot_variant(allele1_pred, allele2_pred, allele1_shap, allele2_shap, allele1_length, allele2_length, allele1_label, allele2_label, window_size, title)
	plt.savefig(save_loc, bbox_inches='tight')
	plt.close()


def _plot_variant_to_utf8(allele1_pred, allele2_pred, allele1_shap, allele2_shap, allele1_length, allele2_length, allele1_label, allele2_label, window_size, title):
	fig = plot_variant(allele1_pred, allele2_pred, allele1_shap, allele2_shap, allele1_length, allele2_length, allele1_label, allele2_label, window_size, title)
...
# PLOTTING UTILITIES #
######################
def plot_variant(allele1_pred, allele2_pred, allele1_shap, allele2_shap, allele1_length, allele2_length, allele1_label, allele2_label, window_size, title):
